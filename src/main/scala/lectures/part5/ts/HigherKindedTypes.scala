...
//    } yield (a,b)
  ...
  // we need to make a common API for all these implementations even though list, option and future are completely unrelated

  // use HKT

  trait Monad[F[_], A]{ // a higher-kinded type class
